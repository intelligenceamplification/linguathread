...
CEFR alignment describes communicative capability. Audio-first lessons ask for sound-to-meaning before showing text, while retaining writing, grammar, orthography, and language comparison. Listening, reading, writing, and self-reported spoken practice remain separate evidence. Later-day retrieval is required for stable mastery; this release does not score pronunciation or claim complete four-skill CEFR certification.
